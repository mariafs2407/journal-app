...
export const LoginPage = () => {
    ...
    //si el STATUS cambia entonces se va a volver a obtener el valor, si no cambia se guarda el valor
    ...
    const onSubmit = (event) => {
        ...
        //no es la opcion para dispacth - dispatch(checkingAuthentication());
